...
export default function Daa({ searchQuery = "" }) {
  ...
  const pdfPath1 = "/Daa_u1c1-2.pdf";
  const pdfPath2 = "/DAa_u1c3.pdf";
  const pdfPath3 = "/DaA _u1c4.pdf";
  ...
  return (
    <main className="container mx-auto px-4 py-8 space-y-12">
      ...
      <div className="max-w-6xl mx-auto p-4 md:p-6">
        {renderPDFViewer("DAA Unit 1 - Part 1, 2", pdfPath1, fullscreen2, () => setFullscreen2(!fullscreen2))}
      </div>

      <div className="max-w-6xl mx-auto p-4 md:p-6">
        {renderPDFViewer("DAA Unit 1 - Part 3", pdfPath2, fullscreen3, () => setFullscreen3(!fullscreen3))}
      </div>

      <div className="max-w-6xl mx-auto p-4 md:p-6">
        {renderPDFViewer("DAA Unit 1 - Part 4", pdfPath3, fullscreen4, () => setFullscreen4(!fullscreen4))}
      </div>
    </main>
  );
}
