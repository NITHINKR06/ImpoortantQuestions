  ...
  const sections = [
    {
      ...
      content: (
        <section class="question" id="q1">
          ...
          <article id="boehm-spiral-model">
            <h3>Boehm Spiral Model</h3>
...

    {
      ...
      content: (
        <section class="question" id="q2">
          ...
          <h3>Requirements for MHC-PMS</h3>
...

    {
      ...
      <h2>5. Requirement Analysis &amp; Code of Ethics</h2>
      ...
      <h3>Software Engineering Code of Ethics (ACM/IEEE)</h3>
      <ul>
